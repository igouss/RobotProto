...
// */
//void I2C::updateRegister(int deviceAddress, uint8_t dataAddress,
//		uint8_t dataValue) {
//	Wire.beginTransmission(deviceAddress);
...
//void I2C::writePage(int deviceAddress, unsigned int addressPage, byte* data,
//		byte length) {
//	Wire.beginTransmission(deviceAddress);
...
//
///**
// * Used to check if device is available
// */
//uint8_t I2C::readWho(int deviceAddress) {
...
//void I2C::eeprom_read_buffer(int deviceAddress, unsigned int address,
